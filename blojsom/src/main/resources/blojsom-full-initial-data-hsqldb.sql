...
INSERT INTO Blog VALUES (NULL, 'default');

CREATE TABLE Category (
  category_id int GENERATED BY DEFAULT AS IDENTITY (START WITH 1, INCREMENT BY 1)  NOT NULL PRIMARY KEY,
...
INSERT INTO Category VALUES (NULL, 1, NULL, '/uncategorized/','Uncategorized');
...
CREATE TABLE Comment (
  comment_id int GENERATED BY DEFAULT AS IDENTITY (START WITH 1, INCREMENT BY 1) NOT NULL PRIMARY KEY,
...
CREATE TABLE Entry (
  entry_id int GENERATED BY DEFAULT AS IDENTITY (START WITH 1, INCREMENT BY 1) NOT NULL PRIMARY KEY,
  blog_id int NOT NULL,
  title varchar(255),
...
CREATE TABLE Pingback (
  pingback_id int GENERATED BY DEFAULT AS IDENTITY (START WITH 1, INCREMENT BY 1) NOT NULL PRIMARY KEY,
  entry_id int NOT NULL,
  title varchar(255),
  excerpt varchar(255),
  url varchar(255),
...
INSERT INTO Template VALUES (1,'irss','irss.vm, text/xml;charset=UTF-8');
...
CREATE TABLE Trackback (
  trackback_id int GENERATED BY DEFAULT AS IDENTITY (START WITH 1, INCREMENT BY 1) NOT NULL PRIMARY KEY,
  entry_id int NOT NULL,
  title varchar(100),
  excerpt varchar(255),
  url varchar(255),
...
CREATE TABLE DBUser (
  user_id int GENERATED BY DEFAULT AS IDENTITY (START WITH 1, INCREMENT BY 1) NOT NULL PRIMARY KEY,
...
INSERT INTO DBUser VALUES (NULL,'blojsom','blojsom','Blojsom User','default_owner@email.com',CURRENT_TIMESTAMP,'',1);

CREATE TABLE DBUserMetadata (
  user_metadata_id int GENERATED BY DEFAULT AS IDENTITY (START WITH 1, INCREMENT BY 1) NOT NULL PRIMARY KEY,
